...
static const std::unordered_map<ImageTexture, TextureInfo> imageTextureInfo_ {
   ...
   {ImageTexture::LightningStrikeCore,
    {"images/lightning-strike-core",
     ":/res/textures/images/lightning-strike-core.svg"}},
   {ImageTexture::LightningStrikeGlow,
    {"images/lightning-strike-glow",
     ":/res/textures/images/lightning-strike-glow.svg"}},
   {ImageTexture::LightningStrikeFlash,
    {"images/lightning-strike-flash",
     ":/res/textures/images/lightning-strike-flash.svg"}},
